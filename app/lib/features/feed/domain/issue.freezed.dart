...
mixin _$Issue {
 ...
 int get id; String get title; String get description; String get category; String get status; double get latitude; double get longitude; String? get geohash; String get ward;@JsonKey(name: 'is_anonymous') bool get isAnonymous;@JsonKey(name: 'is_fuzzed') bool get isFuzzed;@JsonKey(name: 'is_shielded') bool get isShielded;@JsonKey(name: 'reporter_label') String get reporterLabel;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'acknowledged_at') DateTime? get acknowledgedAt;@JsonKey(name: 'resolved_at') DateTime? get resolvedAt;@JsonKey(name: 'resolution_proof') String? get resolutionProof;@JsonKey(name: 'resolution_notes') String? get resolutionNotes;@JsonKey(name: 'upvotes_count') int get upvotesCount;@JsonKey(name: 'confirmations_count') int get confirmationsCount;@JsonKey(name: 'disputes_count') int get disputesCount;@JsonKey(name: 'has_upvoted') bool get hasUpvoted;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,category,status,latitude,longitude,geohash,ward,isAnonymous,isFuzzed,isShielded,reporterLabel,createdAt,acknowledgedAt,resolvedAt,resolutionProof,resolutionNotes,upvotesCount,confirmationsCount,disputesCount,hasUpvoted]);

@override
String toString() {
  return 'Issue(id: $id, title: $title, description: $description, category: $category, status: $status, latitude: $latitude, longitude: $longitude, geohash: $geohash, ward: $ward, isAnonymous: $isAnonymous, isFuzzed: $isFuzzed, isShielded: $isShielded, reporterLabel: $reporterLabel, createdAt: $createdAt, acknowledgedAt: $acknowledgedAt, resolvedAt: $resolvedAt, resolutionProof: $resolutionProof, resolutionNotes: $resolutionNotes, upvotesCount: $upvotesCount, confirmationsCount: $confirmationsCount, disputesCount: $disputesCount, hasUpvoted: $hasUpvoted)';
}
...
@useResult
$Res call({
 int id, String title, String description, String category, String status, double latitude, double longitude, String? geohash, String ward,@JsonKey(name: 'is_anonymous') bool isAnonymous,@JsonKey(name: 'is_fuzzed') bool isFuzzed,@JsonKey(name: 'is_shielded') bool isShielded,@JsonKey(name: 'reporter_label') String reporterLabel,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'acknowledged_at') DateTime? acknowledgedAt,@JsonKey(name: 'resolved_at') DateTime? resolvedAt,@JsonKey(name: 'resolution_proof') String? resolutionProof,@JsonKey(name: 'resolution_notes') String? resolutionNotes,@JsonKey(name: 'upvotes_count') int upvotesCount,@JsonKey(name: 'confirmations_count') int confirmationsCount,@JsonKey(name: 'disputes_count') int disputesCount,@JsonKey(name: 'has_upvoted') bool hasUpvoted
});
...
/// Create a copy of Issue
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = null,Object? category = null,Object? status = null,Object? latitude = null,Object? longitude = null,Object? geohash = freezed,Object? ward = null,Object? isAnonymous = null,Object? isFuzzed = null,Object? isShielded = null,Object? reporterLabel = null,Object? createdAt = null,Object? acknowledgedAt = freezed,Object? resolvedAt = freezed,Object? resolutionProof = freezed,Object? resolutionNotes = freezed,Object? upvotesCount = null,Object? confirmationsCount = null,Object? disputesCount = null,Object? hasUpvoted = null,}) {
  return _then(Issue(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String description,  String category,  String status,  double latitude,  double longitude,  String? geohash,  String ward, @JsonKey(name: 'is_anonymous')  bool isAnonymous, @JsonKey(name: 'is_fuzzed')  bool isFuzzed, @JsonKey(name: 'is_shielded')  bool isShielded, @JsonKey(name: 'reporter_label')  String reporterLabel, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'acknowledged_at')  DateTime? acknowledgedAt, @JsonKey(name: 'resolved_at')  DateTime? resolvedAt, @JsonKey(name: 'resolution_proof')  String? resolutionProof, @JsonKey(name: 'resolution_notes')  String? resolutionNotes, @JsonKey(name: 'upvotes_count')  int upvotesCount, @JsonKey(name: 'confirmations_count')  int confirmationsCount, @JsonKey(name: 'disputes_count')  int disputesCount, @JsonKey(name: 'has_upvoted')  bool hasUpvoted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Issue() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.category,_that.status,_that.latitude,_that.longitude,_that.geohash,_that.ward,_that.isAnonymous,_that.isFuzzed,_that.isShielded,_that.reporterLabel,_that.createdAt,_that.acknowledgedAt,_that.resolvedAt,_that.resolutionProof,_that.resolutionNotes,_that.upvotesCount,_that.confirmationsCount,_that.disputesCount,_that.hasUpvoted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String description,  String category,  String status,  double latitude,  double longitude,  String? geohash,  String ward, @JsonKey(name: 'is_anonymous')  bool isAnonymous, @JsonKey(name: 'is_fuzzed')  bool isFuzzed, @JsonKey(name: 'is_shielded')  bool isShielded, @JsonKey(name: 'reporter_label')  String reporterLabel, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'acknowledged_at')  DateTime? acknowledgedAt, @JsonKey(name: 'resolved_at')  DateTime? resolvedAt, @JsonKey(name: 'resolution_proof')  String? resolutionProof, @JsonKey(name: 'resolution_notes')  String? resolutionNotes, @JsonKey(name: 'upvotes_count')  int upvotesCount, @JsonKey(name: 'confirmations_count')  int confirmationsCount, @JsonKey(name: 'disputes_count')  int disputesCount, @JsonKey(name: 'has_upvoted')  bool hasUpvoted)  $default,) {final _that = this;
switch (_that) {
case _Issue():
return $default(_that.id,_that.title,_that.description,_that.category,_that.status,_that.latitude,_that.longitude,_that.geohash,_that.ward,_that.isAnonymous,_that.isFuzzed,_that.isShielded,_that.reporterLabel,_that.createdAt,_that.acknowledgedAt,_that.resolvedAt,_that.resolutionProof,_that.resolutionNotes,_that.upvotesCount,_that.confirmationsCount,_that.disputesCount,_that.hasUpvoted);case _:
  throw StateError('Unexpected subclass');
...
class _Issue extends Issue {
  const _Issue({required this.id, required this.title, required this.description, required this.category, required this.status, required this.latitude, required this.longitude, this.geohash, this.ward = 'Ward 45, Urban Central', @JsonKey(name: 'is_anonymous') required this.isAnonymous, @JsonKey(name: 'is_fuzzed') this.isFuzzed = false, @JsonKey(name: 'is_shielded') this.isShielded = false, @JsonKey(name: 'reporter_label') required this.reporterLabel, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'acknowledged_at') this.acknowledgedAt, @JsonKey(name: 'resolved_at') this.resolvedAt, @JsonKey(name: 'resolution_proof') this.resolutionProof, @JsonKey(name: 'resolution_notes') this.resolutionNotes, @JsonKey(name: 'upvotes_count') this.upvotesCount = 0, @JsonKey(name: 'confirmations_count') this.confirmationsCount = 0, @JsonKey(name: 'disputes_count') this.disputesCount = 0, @JsonKey(name: 'has_upvoted') this.hasUpvoted = false}): super._();
...
/// Create a copy of Issue
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = null,Object? category = null,Object? status = null,Object? latitude = null,Object? longitude = null,Object? geohash = freezed,Object? ward = null,Object? isAnonymous = null,Object? isFuzzed = null,Object? isShielded = null,Object? reporterLabel = null,Object? createdAt = null,Object? acknowledgedAt = freezed,Object? resolvedAt = freezed,Object? resolutionProof = freezed,Object? resolutionNotes = freezed,Object? upvotesCount = null,Object? confirmationsCount = null,Object? disputesCount = null,Object? hasUpvoted = null,}) {
  return _then(_Issue(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,description: null == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
