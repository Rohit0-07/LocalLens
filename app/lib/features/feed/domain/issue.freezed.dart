...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,category,status,latitude,longitude,geohash,ward,isAnonymous,isFuzzed,isShielded,reporterLabel,createdAt,acknowledgedAt,resolvedAt,resolutionProof,resolutionNotes,upvotesCount,confirmationsCount,disputesCount,hasUpvoted,const DeepCollectionEquality().hash(mediaUrls),videoUrl,reporterId]);

@override
String toString() {
  return 'Issue(id: $id, title: $title, description: $description, category: $category, status: $status, latitude: $latitude, longitude: $longitude, geohash: $geohash, ward: $ward, isAnonymous: $isAnonymous, isFuzzed: $isFuzzed, isShielded: $isShielded, reporterLabel: $reporterLabel, createdAt: $createdAt, acknowledgedAt: $acknowledgedAt, resolvedAt: $resolvedAt, resolutionProof: $resolutionProof, resolutionNotes: $resolutionNotes, upvotesCount: $upvotesCount, confirmationsCount: $confirmationsCount, disputesCount: $disputesCount, hasUpvoted: $hasUpvoted, mediaUrls: $mediaUrls, videoUrl: $videoUrl, reporterId: $reporterId)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,category,status,latitude,longitude,geohash,ward,isAnonymous,isFuzzed,isShielded,reporterLabel,createdAt,acknowledgedAt,resolvedAt,resolutionProof,resolutionNotes,upvotesCount,confirmationsCount,disputesCount,hasUpvoted,const DeepCollectionEquality().hash(_mediaUrls),videoUrl,reporterId]);
