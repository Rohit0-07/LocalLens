...
class _SearchScreenState extends ConsumerState<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: query.isEmpty
          ? _buildEmptyQueryBody(recents)
          : _buildResultsBody(results),
    );
  }

  Widget _buildEmptyQueryBody(List<String> recents) {
    if (recents.isEmpty) {
      return const EmptyState(
        icon: Icons.search,
        title: 'Discover issues near you',
        message: 'Search issues, categories, or wards to get started.',
      );
    }
    return Column(
